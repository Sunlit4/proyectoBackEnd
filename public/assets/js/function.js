export const renderMessages = (messages) =>{
    if (messages){
            ...
            return `<div class="border rounded p-4 w-100 d-flex justify-content-center flex-column gap-4">
                ...
                <div>
                    <form action="/consultas/${
                        ...
                        <input class="border-0 bg-light p-2 px-3 w-100" type="text" required name="message" style="border-radius: 1rem;" id="message-input" placeholder="Deja tu mensaje aquí."/>                            
        ...
        const html = `
            <p>¿Quieres hacer una consulta? </p>
        `;
        document.getElementById("messageList").innerHTML = html;
    } 
};